...
function(install_package)
  ...
  option(EXPORT_${PROJECT_NAME} "Should the ${PROJECT_NAME} package be exported for use by other software" OFF)
  ...
  if(NOT EXPORT_${PROJECT_NAME})
    ...
    if(PACKAGE_LIB_NAME)
      if(POLICY CMP0026)
        cmake_policy(SET CMP0026 NEW) # Use NEW policy to follow best practices
      endif()

      # Use generator expression to get the target file location
      get_target_property(_target_type ${PACKAGE_LIB_NAME} TYPE)
      if(_target_type STREQUAL "EXECUTABLE"
        ...
        set(_lib $<TARGET_FILE:${PACKAGE_LIB_NAME}>)
        list(
          INSERT
          PACKAGE_LINK_LIBS
          0
    ...
    if(PACKAGE_INSTALL_HEADERS)
      foreach(hdr IN LISTS PACKAGE_INSTALL_HEADERS)
        ...
        install(FILES ${_fp} DESTINATION ${PACKAGE_DESTINATION}/${_dir})
      endforeach()
    endif()
