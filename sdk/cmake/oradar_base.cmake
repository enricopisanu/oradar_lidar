...
function(oradar_parse_function_args)
  cmake_parse_arguments(
    ...
    ""
    "NAME"
    "OPTIONS;ONE_VALUE;MULTI_VALUE;REQUIRED;ARGN"
    "${ARGN}")
  cmake_parse_arguments(
    OUT
    "${IN_OPTIONS}"
...
function(oradar_add_module)
  ...
  set(_no_optimization_for_target
...
#
set(all_posix_cmake_targets
    ""
    CACHE INTERNAL "All cmake targets for which optimization can be suppressed")
function(oradar_add_optimization_flags_for_target target)
  ...
  if(NOT ${_no_optimization_for_target})
    ...
    message(
      STATUS
        "Disabling optimization for target '${target}' because it matches the regexp '${_matched_regexp}' in env var CORE_NO_OPTIMIZATION"
    )
